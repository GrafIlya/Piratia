...
bool CMPFont::TextToTexture(char c1, char c2, float& tX, float& tY) {
	...
	if (it == _vecBuf.end()) {
		...
		::TextOut(_hDc, 2, -2, sz, c1 & 0x100 ? 2 : 1);//Ôèêñàöèÿ âûñîòû íàïèñàíèÿ òåêñòà by Jasper
...
//	Çàêîìåíòèðîâàíî ïî ïðè÷èíå íåêîðåêòíîãî îòîáðàæåíèÿ ðóññêîãî ÿçûêà by Jasper
		...
		if (it == _vecBufFast.end()) {
			...
			::TextOut(_hDc, 2, -2, sz, ch[0] & 0x100 ? 2 : 1);//Ôèêñàöèÿ âûñîòû íàïèñàíèÿ òåêñòà by Jasper
