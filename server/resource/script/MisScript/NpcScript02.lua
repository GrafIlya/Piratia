...
function GoToWhere()
	...
	Talk( 1, "Джовиал: Приветствую тебя, пират! Я местный привратник! Куда хочешь отправиться?" )
	Text( 1, "В Пустыню Рихтара! ", JumpPage, 5 )
	--Text( 1, "Go to Thundoria Castle!", JumpPage, 6 )
	Text( 1, "В Ледяной Гирент! ", JumpPage, 7 )
	Text( 1, "Сохранить точку возраждения! ", JumpPage, 24 )
